...
function JollyCalendar({ className, classNames, showOutsideDays = true, errorMessage, ...props }: CalendarProps) {
  return (
    <DayPicker
...
JollyCalendar.displayName = "JollyCalendar"

export { JollyCalendar }
